...
const unisWithUni = graduates.filter(graduates => graduates.university.includes('Uni'));
...
*/
const populationTotal = zooAnimals.reduce((zooAnimals, total) => zooAnimals += total.population, 0);
